        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('student.index') }}" class="btn btn-primary btn-md">All Books</a>
                </div>
            </div>
        </div>
        <!-- /Page Header -->
                    ...
                    <div class="card-body">
                        <form action="{{ route('book.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" name="copies" value="{{ old('copies') }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label">Available Copy</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" name="avail_copy" value="{{ old('avail_copy') }}">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="file" id="prifileImg" class="form-control" name="cover" accept="image/*" value="{{ old('cover') }}"> 
                                    <img style="max-width:160px; width:100%; height:auto; " class="mt-4" id="previewImg" src="" alt="">
                                </div>
                            </div>
                            <div class="form-group row">
